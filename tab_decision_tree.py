...
=========================================================
Course outline: "Decision Tree algorithms, Visualization of Decision Tree using Python"
ULO D: Formulate strategic inferences through Decision Tree Analysis
"""
...
def render(df1, df2, arm, wide):
    ...
    page_header(
        ...
        "Session 3 — Decision Tree algorithms applied to AURA customer interest classification. "
        "Visualise the decision rules, understand feature splits, and extract business-actionable if-then logic.",
        "03 — Decision Tree (Session 3)"
    )
    ...
    fig_cm = go.Figure(go.Heatmap(
        ...
        colorscale=[[0, SURFACE2], [0.5, ORANGE+"88"], [1, GOLD]],
        showscale=False,
        text=cm,

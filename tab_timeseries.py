...
==============================================================
Course outline: "Business Forecasting using Multilinear regression.
Time Series forecasting — basics of ARIMA modelling."
ULO E: Apply forecasting concepts and techniques innovatively to business situations.
"""
...
def render(df1, df2, arm, wide):
    ...
    page_header(
        ...
        "Session 7 — Business forecasting using trend decomposition, moving averages, "
        "multilinear regression with time features, and ARIMA basics applied to "
        "projected AURA pod session demand.",
        "07 — Time Series + ARIMA (Session 7)"
    )
    ...
    section_header("Multilinear Regression Forecast (Session 7)", ORANGE)
    ...
    section_header("ARIMA Basics — Concept + Simulation (Session 7)", INDIGO)

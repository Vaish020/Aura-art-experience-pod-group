...
====================================================================
Course outline Session 8: "Text Mining — Use of NLP in data driven growth for e-commerce industry"
Course outline Session 9: "Ethics, Philosophy and Sociology of AI for Sustainability (ESG Topic)"
ULO A, D, E
"""
...
def render(df1, df2, arm, wide):
    ...
    page_header(
        ...
        "Sessions 8 & 9 — NLP-based sentiment analysis on AURA customer reviews, "
        "topic extraction, word frequency analysis, and AI ethics considerations "
        "for responsible data-driven decision making.",
        "08/09 — Text Mining + Ethics (Sessions 8 & 9)"
    )

    # Tabs for the two sessions
    s8, s9 = st.tabs(["📝 Session 8 — Text Mining & NLP", "⚖️ Session 9 — AI Ethics & ESG"])
    ...
    with s8:
        ...
        info_card(
            ...
            "demonstrating rule-based text mining as taught in Session 8.",
            TEAL
        )
    ...
    # ══════════════════════════════════════════════════════════
    with s9:
        section_header("AI Ethics & ESG — Session 9", GOLD)

        st.markdown(f"""
        <div style="background:{SURFACE2};border-left:3px solid {GOLD};border-radius:8px;
        padding:18px 22px;margin-bottom:24px;">
            <div style="color:{GOLD};font-size:13px;font-weight:700;margin-bottom:8px;">
                Course Session 9: Ethics, Philosophy and Sociology of AI for Sustainability
            </div>
            <div style="color:{MUTED};font-size:13px;line-height:1.8;">
                ...
                implications. This section applies the AI ethics framework from Session 9 
        ...
        info_card(
            ...
            "Session 9 reminds us that <b>data analytics is not value-neutral</b>: "

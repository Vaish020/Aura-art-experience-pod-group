...
==============================================================================
Course outline: "K-Means, RFM and Hierarchical Clustering and its business applications"
"Implementation in Python — K-Means and Hierarchical Clustering"
ULO D: Formulate strategic inferences through Clustering
"""
...
def render(df1, df2, arm, wide):
    ...
    with c2:
        ...
        st.plotly_chart(fig_rfm_sc, use_container_width=True)
